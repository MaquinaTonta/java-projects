...
public class Caesar {
    ...
    /**
     * Key to be input by the user. Default value is zero.
     */
    private int k;
    /**
     * Message to be input by the user. Default value is null
     */
    private String message;
    /**
     * Alphabet to be used by the cipher/decipher process. The list of every 
     * character used by this field can be found in the Constant Field Values
     */
    private final String alphabet = "QW0ERTYU1IOPAS2DFGHJ3KLZX4CVBNM5qwert6yui"
            + "op7asdfg8hjkl9zxcvbnm,.-{}´+¿'|<>°¬!\"#$%&/()=?¡*¨][_;:";
    /**
     * Alphabet to be used by the cipher/decipher process when the restricted 
     * mode is selected. The list of every character used by this field can be 
     * found in the Constante Field Values
     */
