...
/**
 * This class contains the form in charge of the deployment of the message
 * inputted by the user after being ciphered or deciphered. 
 *
...
public class FinalResult extends javax.swing.JFrame {
     ...
     * <li>Set the Caesar Cipher icon to the form</li>
     * </ol>
     */
    public FinalResult() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinalResult.class.getName()).
    ...
    /**
    * Button used to go back to the previous form, <code>CaesarFrame</code>
    */
    private javax.swing.JButton backButton;
    /**
    * Main panel containing every component in the form
    */
    private javax.swing.JPanel principalPanel;
    /**
    * Text field used to display the result of the cipher/decipher process
    */
